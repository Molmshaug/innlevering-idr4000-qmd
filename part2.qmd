...
qpcr_data <- read_excel("data/Part.2/qpcr_data.xlsx", 
...
qpcr_data %>% 
  ...
  tab_header("Tabell 1: qPCR Results")
```

## Diskusjon
Sammensetningen av muskelfibre i menneskelig skjelettmuskulatur kan måles ved bruk av immunhistokjemi. Dette er en teknikk som brukes på vevssnitt. En metode som har en tendens til å være både tidkrevende, teknisk utfordrende og komplisert på grunn av små mengder prøvevev er qPCR [@ellefsen_2014]. De tekniske utfordringene ved å gjennomføre en qPCR er mange og kan være malkvalitet, operatørvariabilitet, selve revers-transkripsjonen og subjektivitet i dataanalyse og rapportering[@bustin_2004]. Dette gjør nøyaktig datatolkning vanskelig, som også ses i vårt tilfelle med en observasjon på MyCH2X som ikke skulle vært tilstede. 
